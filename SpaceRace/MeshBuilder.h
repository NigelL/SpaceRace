...
public:
	...
	static Mesh* MeshBuilder::GenerateCircle(const std::string &meshName,Color color, float lengthX, float lengthY, float lengthZ);
	static Mesh* MeshBuilder::GenerateSphere(const std::string &meshName, Color color, float radius);
	static Mesh* MeshBuilder::GenerateHemiSphere(const std::string &meshName, Color color, float radius);
